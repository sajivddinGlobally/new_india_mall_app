...
import 'package:new_india_mall_app/data/provider/orderController.dart';
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                SizedBox(width: 8),
                                Text(
                                  "Order ID: # ${orderdata.orders[index].orderId}",
                                  style: TextStyle(
                                    fontSize: 16,
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(width: 6),
                                Text(
                                  "Status: ${orderdata.orders[index].status} ",
                            ...
                            SizedBox(height: 6),
                            Column(
                              children: order.items.entries.map<Widget>((
                                entry,
                              ) {
